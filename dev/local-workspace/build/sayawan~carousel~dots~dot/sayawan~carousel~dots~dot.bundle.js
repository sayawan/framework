...
"use strict";
FamousFramework.includes("sayawan:carousel:dots:dot", "HEAD", [], function() {
    (function(){
        'use strict';
    ...
    (function(){
        'use strict';
        FamousFramework.component('sayawan:carousel:dots:dot', 'HEAD', {
            'dependencies': {
                'famous:events': 'HEAD',
            ...
            states: { backgroundColor: 'transparent' },
            tree: '<famous:core:node id="dot"></famous:core:node>'
        });
    }());
    FamousFramework.markComponentAsReady("sayawan:carousel:dots:dot", "HEAD");
});